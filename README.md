...
A modern React-based approach promoting sustainability and environmental consciousness. Built with Vite, Supabase, and integrated AI chat support.
...
- **User Profiles**: User profiles with ratings, verification, and a credit system
